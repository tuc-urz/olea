declare module '@olea/redux-offline/lib/defaults' {
  import { Config } from '@olea/redux-offline/lib/types';

  const config: Config;
  export default config;
}

declare module '@olea/redux-offline/lib/types' {
...
declare module '@olea/redux-offline/lib/constants' {
...
declare module '@olea/redux-offline' {
