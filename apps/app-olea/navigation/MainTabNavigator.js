...
import TimetableCalendarStack                  from './stacks/timetable-calendar';
        ...
        <SafeAreaProvider>
            <View style={{
                ...
                <ConnectivityWarning bottomNavbarHeight={tabBarHeight}>
                    ...
                    {/* <BottomTabs.Screen name='timetableListTab'     options={{ ...TimetableListStack.options,     tabBarAccessibilityLabel: t(TimetableListStack.options.tabBarAccessibilityLabel) }}              >{ TimetableListStack.stack     }</BottomTabs.Screen> */}
                        <BottomTabs.Screen name='timetableCalendarTab' options={{ ...TimetableCalendarStack.options, tabBarAccessibilityLabel: t(TimetableCalendarStack.options.tabBarAccessibilityLabel) }}          >{ TimetableCalendarStack.stack }</BottomTabs.Screen>
